...
<div class="w-9/12 ml-2 flex justify-center">
    ...
    <form action="{{route('edit/levels', $level)}}" method="post">
        ...
        <input type="text" id="id" name="id" value="{{$level->id }}" disabled class="bg-white p-2 mx-5 font-bold rounded-lg
        ...
        <input type="text" id="name" name="name" value="{{old('name') ?? $level->name}}" class="bg-white p-4 py-2 mx-4 rounded-lg

                ...
                <div class="w-8/12 p-2 rounded-lg flex items-center">
                    <div class="p-6 w-10/12">
                        ...
                        <form action="{{route('edit/subjects', $subject)}}" method="post">
                            @csrf
                            <input type="text" id="id" name="id" value="{{$subject->id }}" disabled class="bg-white p-2 mx-4 font-bold rounded-lg
                            border-2 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent">
                            <input type="text" id="name" name="name" value="{{old('name') ?? $subject->name}}" class="bg-white p-4 py-2 mx-4 rounded-lg
                            border-2 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent">
                            @error('name')
                            <div>
                                {{$message}}
                            ...
                            <input type="text" id="unit_id" name="unit_id" value="{{old('unit_id') ?? $subject->unit_id}}" class="bg-white p-4 py-2 mx-4 rounded-lg
                            border-2 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent">
                            @error('unit_id')
                            <div>
                                {{$message}}

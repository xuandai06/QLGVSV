@extends('layouts.admin.scientific_research_management_of_student.statistical.menu_statistical')

@section('statistical_science_student')
<div class="flex justify-center mt-2">
    <div class="w-full bg-white p-6 border-2 border-gray-400 rounded-lg">
        <div class="flex justify-center text-2xl text-blue-400">
            <h1>Thống kê đề tài NCKH theo giải thưởng, kết quả</h1>
        </div>
        <div class="m-4">
            <form action="" class="w-8/12 flex justify-between">

                <div class="flex-col">
                    <p class="text-gray-700">Nhập giải thưởng:</p>
                    <input type="text" id="keyword" name="keyword" class="p-1 border-2 border-gray-200
                    focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent" placeholder="Nhập giải thưởng...">
                </div>

                <div class="flex-col">
                    <p class="text-gray-700">Nhập kết quả:</p>
                    <input type="text" id="keyword" name="keyword" class="p-1 border-2 border-gray-200
                    focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent" placeholder="Nhập kết quả...">
                </div>

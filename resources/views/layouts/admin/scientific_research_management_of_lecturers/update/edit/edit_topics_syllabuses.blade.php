            ...
            <div class="w-full bg-gray-200 flex-row justify-between px-6 text-gray-500 rounded-lg mt-1">
                <div class="w-8/12 p-2 rounded-lg flex items-center">
                    <div class="p-6 w-10/12">
                        ...
                        <form action="{{route('edit/kind_of_sciences', $kind_of_science)}}" method="post" class="flex justify-between">
                            @csrf
                            <input type="text" id="temp_id" name="temp_id" value="{{$kind_of_science->id }}" disabled class="bg-white p-2 font-bold rounded-lg">
                            <input type="text" id="name" name="name" value="{{old('name') ?? $kind_of_science->name}}" class="bg-white p-2 mx-4 rounded-lg

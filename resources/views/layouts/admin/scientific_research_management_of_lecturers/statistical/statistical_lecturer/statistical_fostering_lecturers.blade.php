            ...
            <table class="bg-white table-fixed flex-col justify-center">
                <thead>
                    <tr>
                        ...
                        <th class="w-2/12 border-collapse border border-gray-500 p-2">Nội dung đào tạo</th>
                        ...
                        <th class="w-2/12 border-collapse border border-gray-500 p-2">Thời gian bắt đầu</th>
                        <th class="w-1/12 border-collapse border border-gray-500 p-2">Thời gian kết thúc</th>
                        <th class="w-2/12 border-collapse border border-gray-500 p-2">Kết quả</th>

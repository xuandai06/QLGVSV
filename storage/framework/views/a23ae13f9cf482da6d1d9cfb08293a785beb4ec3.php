...
<div class="flex justify-center mt-2">
    <div class="w-full bg-white p-6 border-2 border-gray-400 rounded-lg">
        <div class="flex justify-center text-2xl text-blue-400">
            <h1>Thống kê số lượng sinh viên nội trú, ngoại trú</h1>
        </div>
        <div class="flex justify-center m-4">
            ...
            <div class="flex-col">
                    ...
                    <select name="sex" id="sex" class="bg-white w-full p-2 rounded-lg
                        ...
                        <option value="Nam">Nôi trú</option>
                        <option value="Nữ">Ngoại trú</option>
                    </select>
                </div>
...
<?php echo $__env->make('layouts.admin.student_management.statistical.menu_statistical', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\QLGVSV\resources\views/layouts/admin/student_management/statistical/statistical_student/statistical_student_boarding_outpatient.blade.php ENDPATH**/ ?>
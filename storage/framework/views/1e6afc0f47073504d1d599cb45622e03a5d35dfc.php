        ...
        <div class="flex justify-center m-4">
            ...
            <div class="flex-col">
                ...
                <div class="flex-col">
                    ...
                    <select name="name" id="name" class="bg-white w-full p-2 rounded-lg
                                border-2 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent">
                        <option value="Tốt nghiệp">Điểm học tập</option>
                        <option value="thôi học">Điểm rèn luyện</option>
                    </select>
                </div>
...
<?php echo $__env->make('layouts.admin.student_management.statistical.menu_statistical', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\QLGVSV\resources\views/layouts/admin/student_management/statistical/statistical_student/statistical_student_study_point.blade.php ENDPATH**/ ?>
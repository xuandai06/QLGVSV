                ...
                <div class="w-8/12 p-2 rounded-lg flex items-center">
                    <div class="p-6 w-10/12">
                        ...
                        <form action="<?php echo e(route('add/units')); ?>" method="post" class=" flex-col justify-center">
                            ...
                            <div class="mb-4 flex">
                                <p class="text-gray-500 text-xl w-4/12 pt-3">Danh mục: </p>
                                <input type="text" name="id" id="id" placeholder="Nhập vào danh mục..." class="bg-white w-8/12 p-4 rounded-lg
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4 flex">
                                <p class="text-gray-500 text-xl w-4/12 pt-3">Tên tạp chí: </p>
                    ...
                    <table class="bg-white table-fixed flex-col justify-center">
                        <thead>
                            <tr>
                                ...
                                <th class="w-full border-collapse border border-gray-500 p-2">Tạp chí</th>
...
<?php echo $__env->make('layouts.admin.scientific_research_management_of_lecturers.menu_update', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\QLGVSV\resources\views/layouts/admin/scientific_research_management_of_lecturers/update/nckh_magazine.blade.php ENDPATH**/ ?>
            ...
            <div class="w-full bg-gray-200 flex-row justify-between px-6 text-gray-500 rounded-lg mt-1">
                <div class="w-8/12 p-2 rounded-lg flex items-center">
                    <div class="p-6 w-10/12">
                        ...
                        <form action="<?php echo e(route('edit/work/assignments', ['work_id' => $work_assignment->work_id
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($work_assignment->work_id); ?>" disabled>
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($work_assignment->unit_id); ?>" disabled>
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('role') ?? $work_assignment->role); ?>">
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('note') ?? $work_assignment->note); ?>">
                                </div>
...
<?php echo $__env->make('layouts.admin.teacher_work_schedule.update.menu_update', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\ungDung\laragon\wwww\QLGVSV\resources\views/layouts/admin/teacher_work_schedule/update/edit/edit_work_assignments.blade.php ENDPATH**/ ?>
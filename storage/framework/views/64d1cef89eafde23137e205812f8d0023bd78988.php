            ...
            <div class="w-full bg-gray-200 flex-row justify-between px-6 text-gray-500 rounded-lg mt-1">
                <div class="w-8/12 p-2 rounded-lg flex items-center">
                    <div class="p-6 w-10/12">
                        ...
                        <form action="<?php echo e(route('edit/work/details', ['work_id' => $work_detail->work_id
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($work_detail->work_id); ?>" disabled>
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($work_detail->lecturer_id); ?>" disabled>
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('role') ?? $work_detail->role); ?>">
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('note') ?? $work_detail->note); ?>">
                                </div>
...
<?php echo $__env->make('layouts.admin.teacher_work_schedule.menu_update', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\ungDung\laragon\wwww\QLGVSV\resources\views/layouts/admin/teacher_work_schedule/update/edit/edit_works_detail.blade.php ENDPATH**/ ?>
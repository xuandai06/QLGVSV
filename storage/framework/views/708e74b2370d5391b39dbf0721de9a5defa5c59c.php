    ...
    <div class="w-full bg-white p-6 border-double border-4 border-gray-400 rounded-lg">
        <div class="w-full bg-white flex-col justify-between px-6 text-black rounded-lg mt-1">
            <div class="flex items-center p-1">
                ...
                <p class="clear-left p-2">Cập nhập thông tin chi tiết vai trò tham gia của GV vào HN-HT</p>
            </div>
                ...
                <div class="w-8/12 p-2 rounded-lg flex items-center">
                    <div class="p-6 w-10/12">
                        <div class="text-blue-300 text-2xl font-black mb-6 flex justify-center">
                            <h1 class="">Thêm thông tin chi tiết vai trò tham gia của GV vào HN-HT</h1>
                        </div>
                        ...
                        <form action="<?php echo e(route('add/units')); ?>" method="post" class=" flex-col justify-center">
                            ...
                            <div class="mb-4 flex">
                                <p class="text-gray-500 text-xl w-4/12 pt-3">Tên HN-HT: </p>
                                <input type="text" name="id" id="id" placeholder="Nhập vào tên..." class="bg-white w-8/12 p-4 rounded-lg
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4 flex">
                                <p class="text-gray-500 text-xl w-4/12 pt-3">Cấp thực hiện: </p>
                                <input type="text" name="id" id="id" placeholder="Nhập vào cấp thực hiện..." class="bg-white w-8/12 p-4 rounded-lg
                                border-2 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent <?php $__errorArgs = ['id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4 flex">
                                <p class="text-gray-500 text-xl w-4/12 pt-3">Giáo viên: </p>
                                <input type="text" name="name" id="name" placeholder="Nhập vào tên giáo viên ..." class="bg-white w-8/12 p-4 rounded-lg
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="p-6 mb-2 w-full flex-col border-t-2 border-gray-400">
                    ...
                    <table class="bg-white table-fixed flex-col justify-center">
                        <thead>
                            <tr>
                                <th class="w-2/12 border-collapse border border-gray-500 p-2">Tên HN-HT</th>
...
<?php echo $__env->make('layouts.admin.scientific_research_management_of_lecturers.menu_update', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\QLGVSV\resources\views/layouts/admin/scientific_research_management_of_lecturers/update/nckh_seminor_role.blade.php ENDPATH**/ ?>
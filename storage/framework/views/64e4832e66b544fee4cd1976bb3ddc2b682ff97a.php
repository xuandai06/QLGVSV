            ...
            <div class="w-full bg-gray-200 flex-row justify-between px-6 text-gray-500 rounded-lg mt-1">
                <div class="w-8/12 p-2 rounded-lg flex items-center">
                    <div class="p-6 w-10/12">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('add/positions')); ?>" method="post" class=" flex-col justify-center">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="p-6 mb-2 w-full flex-col border-t-2 border-gray-400">
                    ...
                    <nav class="w-8/12 p-2 flex-row-reverse justify-between">
                        <form action="<?php echo e(route('search/positions')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            ...
                            <button type="submit" class="px-3 py-1 bg-white hover:bg-blue-400 hover:text-white" value="<?php echo e(old('id')); ?>">Search</button>
                        </form>
                    </nav>
                    <table class="bg-white table-fixed flex-col justify-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="border-collapse border border-gray-500 p-2"><?php echo e($position->id); ?></td>
                                <td class="border-collapse border border-gray-500 p-2"><?php echo e($position->name); ?></td>
                                <td class="border-collapse border border-gray-500 p-2">
                                    <a href="<?php echo e(route('edit/positions/index', $position->id)); ?>">Edit</a>
                                </td>
                                <td class="border-collapse border border-gray-500 p-2">
                                    <form action="<?php echo e(route('delete/positions', $position)); ?>" method="post">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin.lecturer_management.menu_update', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\Tong hop de cuong on tap\du_an\QLGVSV\resources\views/layouts/admin/lecturer_management/update/update_positions.blade.php ENDPATH**/ ?>
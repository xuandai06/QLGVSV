        ...
        <div class="flex justify-center m-4">
            ...
            <div class="flex-col">
                    ...
                    <select name="sex" id="sex" class="bg-white w-full p-2 rounded-lg
                        ...
                        <option value="Nam">Lớp</option>
                        <option value="Nữ">Ngành</option>
                        <option value="Khác">Khóa</option>
                    </select>
                </div>
...
<?php echo $__env->make('layouts.admin.student_management.statistical.menu_statistical', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\QLGVSV\resources\views/layouts/admin/student_management/statistical/statistical_student/statistical_number_of_student.blade.php ENDPATH**/ ?>
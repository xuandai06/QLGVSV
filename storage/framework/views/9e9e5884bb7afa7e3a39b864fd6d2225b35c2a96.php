    ...
    <div class="w-full bg-white p-6 border-2 border-gray-400 rounded-lg">
        ...
        <div class="w-full flex-col border-t-2 border-gray-400">
            ...
            <table class="bg-white table-fixed flex-col justify-center">
                <thead>
                    <tr>
                    <th class="w-1/12 border-collapse border border-gray-500 p-2">Mã phòng</th>
                    <th class="w-1/12 border-collapse border border-gray-500 p-2">Sức chứa</th>
                        <th class="w-2/12 border-collapse border border-gray-500 p-2">Ngày học</th>
...
<?php echo $__env->make('layouts.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\QLGVSV\resources\views/layouts/admin/timetable/Search/search_by_rooms.blade.php ENDPATH**/ ?>
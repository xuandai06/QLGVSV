    ...
    <div class="w-full bg-white p-6 border-double border-4 border-gray-400 rounded-lg">
        <div class="w-full bg-white flex-col justify-between px-6 text-black rounded-lg mt-1">
            <div class="flex items-center p-1">
                ...
                <p class="clear-left p-2">Cập nhập danh mục tạp chí</p>
            </div>
                ...
                <div class="w-8/12 p-2 rounded-lg flex items-center">
                    <div class="p-6 w-10/12">
                        <div class="text-blue-300 text-2xl font-black mb-6 flex justify-center">
                            <h1 class="">Thêm danh mục tạp chí</h1>
                        </div>
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('add/journals')); ?>" method="post" class=" flex-col justify-center">
                            <?php echo csrf_field(); ?>

                            <div class="mb-4 flex-col">
                                <div class="flex">
                                    <p class="text-gray-500 text-xl w-5/12 pt-3">Mã tạp chí: </p>
                                    <input type="text" name="id" id="id" placeholder="Nhập vào mã tạp chí..." class="bg-white w-8/12 p-4 rounded-lg
...
$message = $__bag->first($__errorArgs[0]); ?>
                                <div class="text-red-500 mt-2 pl-48 text-sm">
                                    <?php echo e($message); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4 flex-col">
                                <div class="flex">
                                    <p class="text-gray-500 text-xl w-5/12 pt-3">Tên tạp chí: </p>
                                    <input type="text" name="name" id="name" placeholder="Nhập vào tên tạp chí ..." class="bg-white w-8/12 p-4 rounded-lg
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4 flex-col">
                                <div class="flex">
                                    <p class="text-gray-500 text-xl w-5/12 pt-3">Hệ số điểm: </p>
                                    <input type="text" name="score" id="score" placeholder="Nhập vào tên hệ số điểm ..." class="bg-white w-8/12 p-4 rounded-lg
                                border-2 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent <?php $__errorArgs = ['score'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="p-6 mb-2 w-full flex-col border-t-2 border-gray-400">
                    <div class="text-gray-700 text-2xl font-black mb-2 flex justify-center">
                        <h1 class="">Danh sách tạp trí</h1>
                    </div>
                    <nav class="w-8/12 p-2 flex-row-reverse justify-between">
                        <form action="<?php echo e(route('search/journals')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                    ...
                    <table class="bg-white table-fixed flex-col justify-center">
                        <thead>
                            <tr>
                                <th class="w-2/12 border-collapse border border-gray-500 p-2">Mã tạp trí</th>
                                <th class="w-7/12 border-collapse border border-gray-500 p-2">Tên tạp trí</th>
                                <th class="w-2/12 border-collapse border border-gray-500 p-2">Hệ số điểm</th>
...
<?php echo $__env->make('layouts.admin.scientific_research_management_of_lecturers.menu_update', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\QLGVSV\resources\views/layouts/admin/scientific_research_management_of_lecturers/update/update_journals.blade.php ENDPATH**/ ?>
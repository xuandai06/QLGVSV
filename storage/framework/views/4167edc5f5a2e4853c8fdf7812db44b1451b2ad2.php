                    ...
                    <div class="p-6 w-10/12">
                        ...
                        <form action="<?php echo e(route('edit/lecturers', $lecturer)); ?>" method="post">
                            ...
                            <div class="flex justify-between">
                                ...
                                <input disabled type="text" id="id" name="id" value="<?php echo e($lecturer->id); ?>" class="w-6/12 bg-white p-2 mx-2 rounded-lg
...
<?php echo $__env->make('layouts.admin.lecturer_management.menu_update', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\Tong hop de cuong on tap\du_an\QLGVSV\resources\views/layouts/admin/lecturer_management/update/edit/edit_lecturers.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('menuadmin'); ?>
    <div class="absolute w-2/12 h-screen bg-white hidden flex justify-between px-6 py-3 rounded-lg mt-1" id="dropdown">
        <div class="flex items-center rounded-lg duration-300 ease-in-out hover:bg-blue-200 px-2 hover:text-white p-1">
            ...
            <a href="<?php echo e(route('home')); ?>" class="clear-left p-2">Trang chủ</a>
        </div>
        ...
        <div class="flex items-center rounded-lg duration-300 ease-in-out hover:bg-blue-200 px-2 hover:text-white p-1">
            ...
            <button class="clear-left p-2" id="teacher">Thông tin</button>
        </div>
        ...
        <div class="w-full bg-white hidden flex-col justify-between px-6 text-gray-500 rounded-lg mt-1" id="dropteacher">
            <div class="flex items-center rounded-lg duration-300 ease-in-out hover:bg-blue-200 px-2 hover:text-white p-1">
                ...
                <a href="" class="clear-left p-2">Cập nhật thông tin</a>
            </div>
        ...
        <div class="flex items-center rounded-lg duration-300 ease-in-out hover:bg-blue-200 px-2 hover:text-white p-1">
            ...
            <button class="clear-left p-2" id="student">NCKH-SV</button>
        </div>
...
<?php echo $__env->make('layouts.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\Tong hop de cuong on tap\du_an\QLGVSV\resources\views/layouts/student/menu.blade.php ENDPATH**/ ?>
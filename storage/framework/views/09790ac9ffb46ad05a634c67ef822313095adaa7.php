...
<div class="flex justify-center mt-2">
    <div class="w-full bg-white p-6 border-2 border-gray-400 rounded-lg">
        <div class="flex justify-center text-2xl text-blue-400">
            <h1>Tìm kiếm theo sinh viên thôi học</h1>
        </div>
            ...
            <table class="bg-white table-fixed flex-col justify-center">
                <thead>
                    <tr>
                        ...
                        <th class="w-1/12 border-collapse border border-gray-500 p-2">Lý do thôi học</th>
...
<?php echo $__env->make('layouts.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\QLGVSV\resources\views/layouts/admin/student_management/search/search_student_quit.blade.php ENDPATH**/ ?>
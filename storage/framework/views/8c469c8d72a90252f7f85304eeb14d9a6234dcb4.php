    ...
    <div class="w-full bg-white p-6 border-double border-4 border-gray-400 rounded-lg">
        <div class="w-full bg-white flex-col justify-between px-6 text-black rounded-lg mt-1">
            <div class="flex items-center p-1">
                ...
                <p class="clear-left p-2">Cập nhập thông tin chi tiết về đề tài NCKH hay giáo trình, bài báo</p>
            </div>
                ...
                <div class="w-8/12 p-2 rounded-lg flex items-center">
                    <div class="p-6 w-10/12">
                        <div class="text-blue-300 text-2xl font-black mb-6 flex justify-center">
                            <h1 class="">Thêm đề tài NCKH hay giáo trình, bài báo</h1>
                        </div>
                        ...
                        <form action="<?php echo e(route('add/units')); ?>" method="post" class=" flex-col justify-center">
                            ...
                            <div class="mb-4 flex">
                                <p class="text-gray-500 text-xl w-4/12 pt-3">Đề tài NCKH/ Giáo trình/ Bài báo: </p>
...
<?php echo $__env->make('layouts.admin.scientific_research_management_of_lecturers.menu_update', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\QLGVSV\resources\views/layouts/admin/scientific_research_management_of_lecturers/update/nckh_info.blade.php ENDPATH**/ ?>
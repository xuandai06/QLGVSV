            ...
            <div class="w-full bg-gray-200 flex-row justify-between px-6 text-gray-500 rounded-lg mt-1">
                <div class="w-8/12 p-2 rounded-lg flex items-center">
                    <div class="p-6 w-10/12">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('add/work/details')); ?>" method="post" class=" flex-col justify-center">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="flex">
                                    ...
                                    <div class="flex">
                                        ...
                                        <select name="lecturer_id" id="lecturer_id">
                                            ...
                                            <?php if(session('lecturer_id') == $lecturer->id): ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('note') ?? session('note')); ?>">
                ...
                <div class="p-6 mb-2 w-full flex-col border-t-2 border-gray-400">
                    ...
                    <nav class="w-8/12 p-2 flex-row-reverse justify-between">
                        <form action="<?php echo e(route('search/work/details')); ?>">
                            <?php echo csrf_field(); ?>
                    ...
                    <table class="bg-white table-fixed flex-col justify-center">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $work_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $work_detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="border-collapse border border-gray-500 p-2"><?php echo e($work_detail->work_id); ?></td>
                                <td class="border-collapse border border-gray-500 p-2"><?php echo e($work_detail->lecturer_id); ?></td>
                                <td class="border-collapse border border-gray-500 p-2"><?php echo e($work_detail->role); ?></td>
                                <td class="border-collapse border border-gray-500 p-2"><?php echo e($work_detail->note); ?></td>
                                <td class="border-collapse border border-gray-500 p-2">
                                    <a href="<?php echo e(route('edit/work/details/index', ['work_id' => $work_detail->work_id
                                        , 'lecturer_id' => $work_detail->lecturer_id])); ?>">Edit</a>
                                </td>
                                <td class="border-collapse border border-gray-500 p-2">
                                    <form action="<?php echo e(route('delete/work/details', ['work_id' => $work_detail->work_id
...
<?php echo $__env->make('layouts.admin.teacher_work_schedule.menu_update', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\ungDung\laragon\wwww\QLGVSV\resources\views/layouts/admin/teacher_work_schedule/update/update_works_detail.blade.php ENDPATH**/ ?>
            ...
            <div class="w-3/12 bg-gray-200 rounded-lg p-2">
                ...
                <div class="text-gray-500 p-3">
                    <ul class="flex-col">
                        ...
                        <li class="px-2 py-3 rounded-lg hover:bg-blue-400 hover:text-white">
                            <a href="<?php echo e(route('update/lecturers')); ?>">=> Cập nhật thông tin về thông tin cá nhân</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<?php echo $__env->make('layouts.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Tong hop de cuong on tap\du_an\QLGVSV\resources\views/layouts/admin/lecturer_management/menu_update.blade.php ENDPATH**/ ?>
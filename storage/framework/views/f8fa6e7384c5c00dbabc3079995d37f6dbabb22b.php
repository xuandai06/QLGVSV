                ...
                <div class="w-8/12 p-2 rounded-lg flex items-center">
                    <div class="p-6 w-10/12">
                        <div class="text-blue-300 text-2xl font-black mb-6 flex justify-center">
                            <h1 class="">Thêm thông tin Điểm học tập/ Rèn luyện</h1>
                        </div>
                    ...
                    <table class="bg-white table-fixed flex-col justify-center">
                        <thead>
                            <tr>
                                ...
                                <th class="w-full border-collapse border border-gray-500 p-2">Mã HP</th>
                                <th class="w-1/12 border-collapse border border-gray-500 p-2">Tên HP</th>
                                <th class="w-1/12 border-collapse border border-gray-500 p-2">Số tín chỉ</th>
                                <th class="w-1/12 border-collapse border border-gray-500 p-2">TBC thành phần</th>
                                <th class="w-1/12 border-collapse border border-gray-500 p-2">Điểm thi HP</th>
                                <th class="w-1/12 border-collapse border border-gray-500 p-2">Số tín chỉ tích lũy</th>
                                <th class="w-1/12 border-collapse border border-gray-500 p-2">TBC tích lũy hệ 4</th>
                                <th class="w-1/12 border-collapse border border-gray-500 p-2">Kỳ</th>
...
<?php echo $__env->make('layouts.admin.student_management.menu_update', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\QLGVSV\resources\views/layouts/admin/student_management/update/update_student_study_point.blade.php ENDPATH**/ ?>
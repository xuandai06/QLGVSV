            ...
            <ul class="flex items-center">
                <li class="flex items-center rounded-lg">
                    <ul class="flex items-center">
                            ...
                            group-hover:opacity-100 group-hover:flex">
                                <ul class="mx-6">
                                    <li class="flex items-center rounded-lg duration-300 ease-in-out hover:bg-blue-200 px-2 hover:text-white p-1">
                                        ...
                                        <a href="<?php echo e(route('update_gv')); ?>" class="clear-left p-2">Cập nhập</a>
                                    </li>
                                    <li class="flex items-center rounded-lg duration-300 ease-in-out hover:bg-blue-200 px-2 hover:text-white p-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <li class="flex items-center rounded-lg duration-300 ease-in-out hover:bg-blue-200 px-2 hover:text-white p-1">
                            <a href="" class="clear-left p-2 font-bold" id="student">Quản lý sinh viên</a>
                        </li>

                        <li class="flex items-center rounded-lg duration-300 ease-in-out hover:bg-blue-200 px-2 hover:text-white p-1">
                            <a href="" class="clear-left p-2 font-bold" id="nckh_gv">Quản lý NCKH-GV</a>
                        </li>

                        <li class="flex items-center rounded-lg duration-300 ease-in-out hover:bg-blue-200 px-2 hover:text-white p-1">
                            <a href="" class="clear-left p-2 font-bold" id="nckh_sv">Quản lý NCKH-SV</a>
                        </li>

                        <li class="flex items-center rounded-lg duration-300 ease-in-out hover:bg-blue-200 px-2 hover:text-white p-1">
                            <a href="" class="clear-left p-2 font-bold" id="lich_ct">Lịch công tác GV</a>
                        </li>

                        <li class="flex items-center rounded-lg duration-300 ease-in-out hover:bg-blue-200 px-2 hover:text-white p-1">
                            <a href="" class="clear-left p-2 font-bold" id="tkb_sv">TKB SV</a>
                        </li>
                    </ul>
                </li>
            </ul>

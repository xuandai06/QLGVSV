    ...
    <div class="w-full bg-white p-6 border-double border-4 border-gray-400 rounded-lg">
        <div class="w-full bg-white flex-col justify-between px-6 text-black rounded-lg mt-1">
            <div class="flex items-center p-1">
                ...
                <p class="clear-left p-2">Cập nhập thông tin tốt nghiệp</p>
            </div>
                ...
                <div class="w-8/12 p-2 rounded-lg flex items-center">
                    <div class="p-6 w-10/12">
                        <div class="text-blue-300 text-2xl font-black mb-6 flex justify-center">
                            <h1 class="">Thêm thông tin tốt nghiệp</h1>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4 flex-col">
                                <div class="flex">
                                    <p class="text-gray-500 text-xl w-4/12 pt-3">Thời gian tốt nghiệp: </p>
                    ...
                    <table class="bg-white table-fixed flex-col justify-center">
                        <thead>
                            <tr>
                                ...
                                <th class="w-2/12 border-collapse border border-gray-500 p-2">Thời gian tốt nghiệp</th>
...
<?php echo $__env->make('layouts.admin.student_management.menu_update', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\QLGVSV\resources\views/layouts/admin/student_management/update/update_student_graduate.blade.php ENDPATH**/ ?>
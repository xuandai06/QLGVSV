    ...
    <div class="w-full bg-white p-6 border-2 border-gray-400 rounded-lg">
        ...
        <div class="flex justify-center m-4">
            <form action="<?php echo e(route('search/details/lecturers')); ?>" class="w-6/12 flex justify-between">
                ...
                <div class="flex-col">
                    <p class="text-gray-700">Nhập tiết bắt đầu:</p>
                    <input type="text" id="keyword" name="keyword" class="p-1 border-2 border-gray-200
                    focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent" placeholder="Nhập tiết bắt đầu ...">
                </div>
        ...
        <div class="w-full flex-col border-t-2 border-gray-400">
            ...
            <table class="bg-white table-fixed flex-col justify-center">
                <thead>
                    <tr>
                         <th class="w-1/12 border-collapse border border-gray-500 p-2">Mã HP</th>
                        <th class="w-2/12 border-collapse border border-gray-500 p-2">Mã lớp HP</th>
                        <th class="w-1/12 border-collapse border border-gray-500 p-2">Mã GV</th>
                        <th class="w-2/12 border-collapse border border-gray-500 p-2">Mã phòng</th>
...
<?php echo $__env->make('layouts.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\QLGVSV\resources\views/layouts/admin/timetable/Search/search_by_teaching_day_and_lesson.blade.php ENDPATH**/ ?>
    ...
    <div class="w-full bg-white p-6 border-double border-4 border-gray-400 rounded-lg">
        <div class="w-full bg-white flex-col justify-between px-6 text-black rounded-lg mt-1">
            <div class="flex items-center p-1">
                ...
                <p class="clear-left p-2">Cập nhập thông tin ngoại trú</p>
            </div>
                ...
                <div class="w-8/12 p-2 rounded-lg flex items-center">
                    <div class="p-6 w-10/12">
                        <div class="text-blue-300 text-2xl font-black mb-6 flex justify-center">
                            <h1 class="">Thêm thông tin ngoại trú</h1>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4 flex-col">
                                <div class="flex">
                                    <p class="text-gray-500 text-xl w-4/12 pt-3">Nơi ở: </p>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4 flex-col">
                                <div class="flex">
                                    <p class="text-gray-500 text-xl w-4/12 pt-3">Chủ nhà trọ: </p>
                                    <input type="text" name="name" id="name" placeholder="Nhập tên..." class="bg-white w-8/12 p-4 rounded-lg
                                border-2 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4 flex-col">
                                <div class="flex">
                                    <p class="text-gray-500 text-xl w-4/12 pt-3">SĐT nhà trọ: </p>
                                    <input type="text" name="name" id="name" placeholder="Nhập SĐT..." class="bg-white w-8/12 p-4 rounded-lg
                                border-2 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                    ...
                    <table class="bg-white table-fixed flex-col justify-center">
                        <thead>
                            <tr>
                                ...
                                <th class="w-full border-collapse border border-gray-500 p-2">Thời gian bắt đầu</th>
                                <th class="w-1/12 border-collapse border border-gray-500 p-2">Thời gian kết thúc</th>
                                <th class="w-1/12 border-collapse border border-gray-500 p-2">Nơi ở</th>
                                <th class="w-1/12 border-collapse border border-gray-500 p-2">Chủ nhà trọ</th>
                                <th class="w-1/12 border-collapse border border-gray-500 p-2">SĐT nhà trọ</th>
...
<?php echo $__env->make('layouts.admin.student_management.menu_update', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\QLGVSV\resources\views/layouts/admin/student_management/update/update_student_outpatient.blade.php ENDPATH**/ ?>
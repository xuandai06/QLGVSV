            ...
            <div class="w-full bg-gray-200 flex-row justify-between px-6 text-gray-500 rounded-lg mt-1">
                <div class="w-8/12 p-2 rounded-lg flex items-center">
                    <div class="p-6 w-10/12">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('edit/conferences',$conference)); ?>" method="post" class=" flex-col justify-center">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" disabled value="<?php echo e($conference->id); ?>">
                                </div>
                                <?php $__errorArgs = ['id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name') ?? $conference->name); ?>">
                                </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('time') ?? $conference->time); ?>">
                                </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('place') ?? $conference->place); ?>">
                                </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('note') ?? $conference->note); ?>">
                                </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('implementation_level_id') ?? $conference->implementation_level_id); ?>">
                                </div>

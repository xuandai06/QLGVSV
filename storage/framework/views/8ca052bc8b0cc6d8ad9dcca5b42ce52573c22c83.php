                ...
                <div class="p-6 mb-2 w-full flex-col border-t-2 border-gray-400">
                    ...
                    <table class="bg-white table-fixed flex-col justify-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="border-collapse border border-gray-500 p-2"><?php echo e($article->id); ?></td>
                                ...
                                <td class="border-collapse border border-gray-500 p-2"><?php echo e($article->time); ?></td>
                                <td class="border-collapse border border-gray-500 p-2"><?php echo e($article->note); ?></td>
                                <td class="border-collapse border border-gray-500 p-2"><?php echo e($article->journal_id); ?></td>
                                <td class="border-collapse border border-gray-500 p-2">
                                    <a href="<?php echo e(route('edit/articles/index',$article->id)); ?>">Edit</a>
                                </td>
                                <td class="border-collapse border border-gray-500 p-2">
                                    <form action="<?php echo e(route('delete/articles',$article)); ?>" method="post">
                                        <?php echo csrf_field(); ?>

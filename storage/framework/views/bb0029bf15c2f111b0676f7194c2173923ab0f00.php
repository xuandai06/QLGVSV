    ...
    <div class="w-full bg-white p-6 border-double border-4 border-gray-400 rounded-lg">
        <div class="w-full bg-white flex-col justify-between px-6 text-black rounded-lg mt-1">
            <div class="flex items-center p-1">
                ...
                <p class="clear-left p-2">Cập nhập danh mục tạp trí</p>
            </div>
                ...
                <div class="w-8/12 p-2 rounded-lg flex items-center">
                    <div class="p-6 w-10/12">
                        <div class="text-blue-300 text-2xl font-black mb-6 flex justify-center">
                            <h1 class="">Thêm danh mục tạp trí</h1>
                        </div>
                        ...
                        <form action="<?php echo e(route('add/journals')); ?>" method="post" class=" flex-col justify-center">
                            ...
                            <div class="mb-4 flex-col">
                                <div class="flex">
                                    ...
                                    <input type="text" name="id" id="id" placeholder="Nhập vào mã tạp trí..." class="bg-white w-8/12 p-4 rounded-lg
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4 flex-col">
                                <div class="flex">
                                    <p class="text-gray-500 text-xl w-5/12 pt-3">Tên tạp trí: </p>
                                    <input type="text" name="name" id="name" placeholder="Nhập vào tên tạp trí ..." class="bg-white w-8/12 p-4 rounded-lg

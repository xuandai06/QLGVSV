            ...
            <div class="w-3/12 bg-gray-200 rounded-lg p-2">
                ...
                <div class="text-gray-500 p-3">
                    <ul class="flex-col">
                        ...
                        <li class="px-2 py-3 rounded-lg hover:bg-blue-400 hover:text-white">
                            <a href="">=> Cập nhật danh mục tạp chí</a>
                        </li>

                        <li class="px-2 py-3 rounded-lg hover:bg-blue-400 hover:text-white">
                            <a href="">=> Cập nhật thông tin chi tiết về đề tài NCKH hay giáo trình/ bài báo</a>
                        </li>

                        <li class="px-2 py-3 rounded-lg hover:bg-blue-400 hover:text-white">
                            <a href="">=> Cập nhật thông tin về vai trò tham gia của GV vào NCKH hay giáo trình/ bài báo</a>
                        </li>

                        <li class="px-2 py-3 rounded-lg hover:bg-blue-400 hover:text-white">
                            <a href="">=> Cập nhật danh mục hội thảo, hội nghị</a>
                        </li>

                        <li class="px-2 py-3 rounded-lg hover:bg-blue-400 hover:text-white">
                            <a href="">=> Cập nhật thông tin chi tiết vai trò tham gia của GV vào HN-HT</a>
                        </li>
                        <li class="px-2 py-3 rounded-lg hover:bg-blue-400 hover:text-white">
                            <a href="">=> Cập nhật về bồi dưỡng của GV</a>
                        </li>
                    </ul>
                </div>
            </div>

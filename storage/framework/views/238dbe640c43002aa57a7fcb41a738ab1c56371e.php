...
unset($__errorArgs, $__bag); ?>
                            ...
                            <input type="text" id="email" name="email" value="<?php echo e(old('email') ?? $lecturer->user->email); ?>" class="bg-white p-3 ml-16 rounded-lg
                            border-2 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent">
                            <hr>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            border-2 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent">
                                ...
                                <input type="date" id="birthday" name="birthday" value="<?php echo e(old('birthday') ?? $lecturer->birthday); ?>" class="bg-white p-2 mx-8 rounded-lg
                            border-2 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent">
                                <hr>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <input type="text" id="hometown" name="hometown" value="<?php echo e(old('hometown') ?? $lecturer->hometown); ?>" class="bg-white p-2 mx-8 rounded-lg
                            border-2 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent">
                                <hr>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <input type="text" id="address" name="address" value="<?php echo e(old('address') ?? $lecturer->address); ?>" class="bg-white p-2 mx-14 rounded-lg
                            border-2 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent">
                                <hr>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <input type="text" id="phone_number" name="phone_number" value="<?php echo e(old('phone_number') ?? $lecturer->phone_number); ?>" class="bg-white p-2 mx-8 rounded-lg
                            border-2 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent">
                                <hr>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <input type="text" id="note" name="note" value="<?php echo e(old('note') ?? $lecturer->note); ?>" class="bg-white p-2 mx-12 rounded-lg
                            border-2 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent">
                                <hr>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <input type="text" id="level_id" name="level_id" value="<?php echo e(old('level_id') ?? $lecturer->level_id); ?>" class="bg-white p-2 mx-10 rounded-lg
                            border-2 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent">
                                <hr>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <input type="text" id="major_id" name="major_id" value="<?php echo e(old('major_id') ?? $lecturer->major_id); ?>" class="bg-white p-2 mx-8 rounded-lg
                            border-2 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent">
                                <hr>
...
<?php echo $__env->make('layouts.admin.lecturer_management.menu_update', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\QLGVSV\resources\views/layouts/admin/lecturer_management/update/edit/edit_lecturers.blade.php ENDPATH**/ ?>
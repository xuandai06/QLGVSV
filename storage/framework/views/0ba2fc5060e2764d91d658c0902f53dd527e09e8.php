...
<div class="w-full ml-2 flex justify-between mt-2">
    <div class="w-full bg-white p-6 border-2 border-gray-400 rounded-lg">
        ...
        <div class="flex justify-center m-4">
            <form action="<?php echo e(route('search/kind_of_sciences/keyword')); ?>" class="w-6/12 flex justify-between">
...
<?php echo $__env->make('layouts.admin.scientific_research_management_of_lecturers.search.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Tong hop de cuong on tap\du_an\QLGVSV\resources\views/layouts/admin/scientific_research_management_of_lecturers/search/search_lecturer/search_kind_of_sciences.blade.php ENDPATH**/ ?>
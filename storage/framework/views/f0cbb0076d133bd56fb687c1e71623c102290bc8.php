    ...
    <div class="w-full bg-white p-6 border-2 border-gray-400 rounded-lg">
        ...
        <div class="flex justify-center m-4">
            <form action="<?php echo e(route('search/details/lecturers')); ?>" class="w-6/12 flex justify-between">
                ...
                <div class="flex-col">
                    <p class="text-gray-700">Nhập vai trò: </p>
                    <input type="text" id="keyword" name="keyword" class="p-1.5 border-2 border-gray-200
            ...
            <table class="bg-white table-fixed flex-col justify-center">
                <thead>
                    <tr>
                        ...
                        <th class="w-2/12 border-collapse border border-gray-500 p-2">Tên loại khoa học</th>
...
<?php echo $__env->make('layouts.admin.scientific_research_management_of_lecturers.search.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\QLGVSV\resources\views/layouts/admin/scientific_research_management_of_lecturers/search/search_lecturer/search_lecturer_role.blade.php ENDPATH**/ ?>
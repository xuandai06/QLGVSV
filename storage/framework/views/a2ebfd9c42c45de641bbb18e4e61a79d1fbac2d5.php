            ...
            <div class="w-full bg-gray-200 flex-row justify-between px-6 text-gray-500 rounded-lg mt-1">
                <div class="w-8/12 p-2 rounded-lg flex items-center">
                    <div class="p-6 w-10/12">
                        ...
                        <form action="<?php echo e(route('edit/implementation_levels', $implementation_levels)); ?>" method="post" class="flex justify-between">
                            <?php echo csrf_field(); ?>
                            <input type="text" id="temp_id" name="temp_id" value="<?php echo e($implementation_levels->id); ?>" disabled class="bg-white p-2 font-bold rounded-lg">
                            <input type="text" id="name" name="name" value="<?php echo e(old('name') ?? $implementation_levels->name); ?>" class="bg-white p-2 mx-4 rounded-lg

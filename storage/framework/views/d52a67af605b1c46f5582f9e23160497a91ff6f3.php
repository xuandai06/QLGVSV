                ...
                <div class="w-8/12 p-2 rounded-lg flex items-center">
                    <div class="p-6 w-10/12">
                        <div class="text-blue-300 text-2xl font-black mb-6 flex justify-center">
                            <h1 class="">Sửa chi tiết bài báo</h1>
                        </div>
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('edit/article_details', ['article_id' => $article_detail->article_id
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($article_detail->article_id); ?>">
                                </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($article_detail->lecturer_id); ?>">
                                </div>

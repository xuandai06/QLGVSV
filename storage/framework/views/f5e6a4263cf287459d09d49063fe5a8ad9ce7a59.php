            ...
            <div class="w-full bg-gray-200 flex-row justify-between px-6 text-gray-500 rounded-lg mt-1">
                <div class="w-8/12 p-2 rounded-lg flex items-center">
                    <div class="p-6 w-10/12">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('edit/conferences_details', ['conference_id' => $conferences_detail->conference_id
                                        , 'lecturer_id' => $conferences_detail->lecturer_id])); ?>" method="post" class=" flex-col justify-center">
                            <?php echo csrf_field(); ?>

                            <div class="mb-4 flex-col">
                                <div class="flex">
                                    <p class="text-gray-500 text-xl w-5/12 pt-3">Mã hội thảo: </p>
                                    <input disabled type="text" name="id" id="id" placeholder="Nhập vào mã hội thảo..." class="bg-white w-8/12 p-4 rounded-lg
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($conferences_detail->conference_id); ?>">
                                </div>
                                <?php $__errorArgs = ['id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4 flex-col">
                                <div class="flex">
                                    ...
                                    <input disabled type="text" name="id_gv" id="id_gv" placeholder="Nhập vào mã giảng viên ..." class="bg-white w-8/12 p-4 rounded-lg
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($conferences_detail->lecturer_id); ?>">
                                </div>

            ...
            <div class="w-full bg-gray-200 flex-row justify-between px-6 text-gray-500 rounded-lg mt-1">
                <div class="w-8/12 p-2 rounded-lg flex items-center">
                    <div class="p-6 w-10/12">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('add/nckh_type')); ?>" method="post" class=" flex-col justify-center">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="p-6 mb-2 w-full flex-col border-t-2 border-gray-400">
                    ...
                    <nav class="w-8/12 p-2 flex-row-reverse justify-between">
                        <form action="<?php echo e(route('search/nckh_type')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border-collapse border border-gray-500 p-2">
                                    <a href="<?php echo e(route('edit/nckh_type/index',$kind_of_science->id)); ?>">Edit</a>
                                </td>
                                <td class="border-collapse border border-gray-500 p-2">
                                    <form action="<?php echo e(route('delete/nckh_type',$kind_of_science)); ?>" method="post">
                                        <?php echo csrf_field(); ?>

...
<?php $__env->startSection('content'); ?>
    <div class="flex justify-center mt-2">
        <div class="w-full bg-white p-6 border-2 border-gray-400 rounded-lg flex justify-between">
            ...
            <?php echo $__env->yieldContent('update_nckh_student'); ?>
        </div>
    </div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\QLGVSV\resources\views/layouts/admin/scientific_research_management_of_student/menu_update.blade.php ENDPATH**/ ?>
            ...
            <div class="w-full bg-gray-200 flex-row justify-between px-6 text-gray-500 rounded-lg mt-1">
                <div class="w-8/12 p-2 rounded-lg flex items-center">
                    <div class="p-6 w-10/12">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('add/conferences_details')); ?>" method="post" class=" flex-col justify-center">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="mb-4 flex-col">
                                <div class="flex">
                                    ...
                                    border-2 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent">
                                        ...
                                        <?php if(session('conference_id') == $conference->id): ?>
                                        <option selected value="<?php echo e($conference->id); ?>"><?php echo e($conference->id); ?></option>
                                        <?php else: ?>
                                        <option value="<?php echo e($conference->id); ?>"><?php echo e($conference->id); ?></option>
                                        <?php endif; ?>

                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <?php $__errorArgs = ['conference_id'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="p-6 mb-2 w-full flex-col border-t-2 border-gray-400">
                    ...
                    <nav class="w-8/12 p-2 flex-row-reverse justify-between">
                        <form action="<?php echo e(route('search/conferences_details')); ?>" method="post">
                            <?php echo csrf_field(); ?>

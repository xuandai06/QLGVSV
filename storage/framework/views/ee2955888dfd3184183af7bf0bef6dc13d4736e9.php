                ...
                <div class="p-6 mb-2 w-full flex-col border-t-2 border-gray-400">
                    ...
                    <nav class="w-8/12 p-2 flex-row-reverse justify-between">
                        <form action="<?php echo e(route('search/positions')); ?>" method="post">
                                    ...
                                    value="<?php echo e(old('id')); ?>">Search</button>
                        </form>
                    </nav>
...
<?php echo $__env->make('layouts.admin.lecturer_management.menu_update', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Tong hop de cuong on tap\du_an\QLGVSV\resources\views/layouts/admin/lecturer_management/update/update_positions.blade.php ENDPATH**/ ?>
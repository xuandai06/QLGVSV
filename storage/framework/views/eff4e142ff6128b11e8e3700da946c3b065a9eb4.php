        ...
        <div class="flex justify-center m-4">
            <form action="<?php echo e(route('search/details/lecturers')); ?>" class="w-6/12 flex justify-between">
                ...
                <label class="flex-col">
                    <p class="text-gray-700">Chọn giới tính</p>
...
<?php echo $__env->make('layouts.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\QLGVSV\resources\views/layouts/admin/student_management/search/search_student/search_student_sex.blade.php ENDPATH**/ ?>